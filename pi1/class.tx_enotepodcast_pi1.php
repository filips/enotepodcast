							...
							if ($fileArrMedia[$testName])	{
								...
								if ($fileMTime_local != $cacheFileMtime_local)	{
									...
									if ($info['media'][$resolution]['_lastWrite']>10)	{
										# Meta data:
										$cmd = 'PERL5LIB=/home/typothree/prefix/usr/lib/perl5/site_perl/5.8.8/i386-linux-thread-multi:/home/typothree/prefix/usr/lib/perl5/site_perl/5.8.8 /home/typothree/prefix/bin/exiftool "'.$testName.'"';
										$res = array();
										$meta = array();
										exec($cmd,$res);
										foreach($res as $line)	{
